...
public class Fragment_SettingMenu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v  = inflater.inflate(R.layout.fragment_settingmenu, container, false);
    ...
    private void initConnectingMainComp(View v) {
        ...
        btn_menu = new View_MenuButton[5];
        ...
        btn_menu[4] = (View_MenuButton) v.findViewById(R.id.btn_menu4);
    ...
    private void initButtonEvent() {
        ...
        btn_menu[4].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.OnMenuSelected(4, menuTitle[4]);
            }
        });
    }
